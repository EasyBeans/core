 ...
 *
 * --------------------------------------------------------------------------
 * $Id: SingletonSessionFactoryIdentifier.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
...
/**
 * Generates an ObjectName for an Singleton Bean MBean.
 *
 * @author Florent Benoit
 */
public class SingletonSessionFactoryIdentifier extends
        SessionFactoryIdentifier<SingletonSessionFactory> {

 ...
 *
 * --------------------------------------------------------------------------
 * $Id: StatefulSessionFactoryIdentifier.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
 ...
 */
public class StatefulSessionFactoryIdentifier extends
        SessionFactoryIdentifier<StatefulSessionFactory> {

    /**
     * JMX MBean Type.
     */
    private static final String TYPE = "StatefulSessionBean";

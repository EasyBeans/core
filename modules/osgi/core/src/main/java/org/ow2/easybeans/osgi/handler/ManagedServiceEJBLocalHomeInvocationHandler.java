 ...
 *
 * --------------------------------------------------------------------------
 * $Id: ManagedServiceEJBLocalHomeInvocationHandler.java 5901 2011-06-07 12:09:35Z benoitf $
 * --------------------------------------------------------------------------
 */
 ...
 */
public class ManagedServiceEJBLocalHomeInvocationHandler extends EJBLocalHomeInvocationHandler
implements Registrable {
    ...
    public Object invoke(final Object proxy,
        ...
        if (method.getDeclaringClass().equals(ManagedService.class)) {
            // There is only 1 method for ManagedSerice, so that's easy :)

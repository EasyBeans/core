 ...
 *
 * --------------------------------------------------------------------------
 * $Id: StatisticComponentServiceFactory.java 5371 2010-02-24 15:02:00Z benoitf $
 * --------------------------------------------------------------------------
 */
package org.ow2.easybeans.osgi.component.statistic;
 ...
 */
public class StatisticComponentServiceFactory extends EZBComponentServiceFactory {
    /**
     * The event component.
     */
    ...
    /**
     * Unset the jmx component.
     * @param jmxComponent The jmx component.
     */
    public synchronized void unsetJmxService(final EZBJmxComponent jmxComponent) {
        this.jmxComponent = null;
    }
    ...
    protected EZBComponent getConfiguredComponent(final Class<? extends EZBComponent> componentClass,
        ...
        StatisticComponent component = (StatisticComponent) super.getConfiguredComponent(componentClass, configuration);
        component.setEventComponent(eventComponent);
        component.setJmxComponent(jmxComponent);
        return component;
    }
}

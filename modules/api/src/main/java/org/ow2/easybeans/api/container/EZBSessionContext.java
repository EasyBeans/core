 ...
 *
 * --------------------------------------------------------------------------
 * $Id: EZBSessionContext.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
...
/**
 * Context that will be stored in the bean object.<br>
...
public interface EZBSessionContext<FactoryType extends Factory<?, ?>> extends EZBEJBContext<FactoryType>, SessionContext {
     ...
     */
    void setBeanTransaction(final Transaction beanTransaction);
}

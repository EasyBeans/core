 ...
 *
 * --------------------------------------------------------------------------
 * $Id: EZBJNDIResolverException.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
...
public class EZBJNDIResolverException extends Exception {
     ...
     */
    public EZBJNDIResolverException(final String message) {
        super(message);
    }
     ...
     *        unknown.)
     */
    public EZBJNDIResolverException(final String message, final Throwable cause) {
        super(message, cause);
    }
     ...
     * @since 1.4
     */
    public EZBJNDIResolverException(final Throwable cause) {
        super(cause);
    }

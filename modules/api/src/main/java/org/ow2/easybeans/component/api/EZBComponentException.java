 ...
 *
 * --------------------------------------------------------------------------
 * $Id: EZBComponentException.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
...
public class EZBComponentException extends Exception {
     ...
     */
    public EZBComponentException(final String message) {
        super(message);
    }
     ...
     *        unknown.)
     */
    public EZBComponentException(final String message, final Throwable cause) {
        super(message, cause);
    }
     ...
     * @since 1.4
     */
    public EZBComponentException(final Throwable cause) {
        super(cause);
    }

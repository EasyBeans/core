 ...
 *
 * --------------------------------------------------------------------------
 * $Id: EasyBeansInjectionException.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
...
public class EasyBeansInjectionException extends Exception {
     ...
     */
    public EasyBeansInjectionException(final String message) {
        super(message);
    }
     ...
     *        unknown.)
     */
    public EasyBeansInjectionException(final String message, final Throwable cause) {
        super(message, cause);
    }
     ...
     * @since 1.4
     */
    public EasyBeansInjectionException(final Throwable cause) {
        super(cause);
    }
}

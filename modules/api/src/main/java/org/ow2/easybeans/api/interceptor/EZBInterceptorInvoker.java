 ...
 *
 * --------------------------------------------------------------------------
 * $Id: EZBInterceptorInvoker.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
...
public interface EZBInterceptorInvoker {
     ...
     * @param interceptorManager the manager of interceptors (in order to ask instance of intereptors)
     * @return the invocation result
     * @throws Exception if there is a failure
     */
    Object invoke(EasyBeansInvocationContext invocationContext, EZBInterceptorManager interceptorManager) throws Exception;

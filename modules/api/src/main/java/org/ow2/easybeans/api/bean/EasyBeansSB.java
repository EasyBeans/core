 ...
 *
 * --------------------------------------------------------------------------
 * $Id: EasyBeansSB.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
 ...
 * @param <PoolType> the type of session bean (SLSB or SFSB)
...
public interface EasyBeansSB<PoolType extends EasyBeansSB> extends EasyBeansBean , EasyBeansSBLifeCycle {
     ...
     * @param easyBeansRemoved true/false
     */
    void setEasyBeansRemoved(final boolean easyBeansRemoved);

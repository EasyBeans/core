 ...
 *
 * --------------------------------------------------------------------------
 * $Id: PersistenceXmlFileAnalyzerException.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
...
public class PersistenceXmlFileAnalyzerException extends Exception {
     ...
     */
    public PersistenceXmlFileAnalyzerException(final String message) {
        super(message);
    }
     ...
     *        unknown.)
     */
    public PersistenceXmlFileAnalyzerException(final String message, final Throwable cause) {
        super(message, cause);
    }

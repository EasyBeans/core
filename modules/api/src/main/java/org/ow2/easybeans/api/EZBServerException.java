 ...
 *
 * --------------------------------------------------------------------------
 * $Id: EZBServerException.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
...
public class EZBServerException extends Exception {
     ...
     */
    public EZBServerException(final String message) {
        super(message);
    }
     ...
     *        unknown.)
     */
    public EZBServerException(final String message, final Throwable cause) {
        super(message, cause);
    }
     ...
     * @since 1.4
     */
    public EZBServerException(final Throwable cause) {
        super(cause);
    }
}

 ...
 *
 * --------------------------------------------------------------------------
 * $Id: JavaContextHelperException.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
...
public class JavaContextHelperException extends Exception {
     ...
     */
    public JavaContextHelperException(final String message) {
        super(message);
    }
     ...
     *        unknown.)
     */
    public JavaContextHelperException(final String message, final Throwable cause) {
        super(message, cause);
    }

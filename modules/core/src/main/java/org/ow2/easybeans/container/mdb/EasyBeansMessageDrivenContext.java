 ...
 *
 * --------------------------------------------------------------------------
 * $Id: EasyBeansMessageDrivenContext.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
 ...
 */
public class EasyBeansMessageDrivenContext extends EasyBeansEJBContext<MDBFactory> implements MessageDrivenContext {

    /**
     * Builds a default Message Driven Context implementation.
     * @param easyBeansFactory used to get the transaction management type.
     */
    public EasyBeansMessageDrivenContext(final MDBFactory easyBeansFactory) {
        super(easyBeansFactory);
    }

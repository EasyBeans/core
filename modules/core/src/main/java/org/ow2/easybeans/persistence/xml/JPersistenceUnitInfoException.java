 ...
 *
 * --------------------------------------------------------------------------
 * $Id: JPersistenceUnitInfoException.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
...
public class JPersistenceUnitInfoException extends Exception {
     ...
     */
    public JPersistenceUnitInfoException(final String message) {
        super(message);
    }
     ...
     *        unknown.)
     */
    public JPersistenceUnitInfoException(final String message, final Throwable cause) {
        super(message, cause);
    }

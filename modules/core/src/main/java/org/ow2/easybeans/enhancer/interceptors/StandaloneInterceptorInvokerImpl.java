 ...
 *
 * --------------------------------------------------------------------------
 * $Id: StandaloneInterceptorInvokerImpl.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
 ...
 */
public class StandaloneInterceptorInvokerImpl implements EZBInterceptorInvoker {
    ...
    /**
     * Name of the class of the interceptor.
     */
    private String interceptorClassname = null;

    /**
     * Build an interceptor invoker for the given interceptor class.
     * @param interceptorClassname the name of the class of the interceptor
    ...
    public StandaloneInterceptorInvokerImpl(final String interceptorClassname, final JMethod jMethod,
        ...
        // Get method
        this.method = MethodHelper.getMethod(interceptorClassname, jMethod, classLoader);
    ...
    public Object invoke(final EasyBeansInvocationContext invocationContext, final EZBInterceptorManager interceptorManager)
        ...
        Object interceptor = interceptorManager.getInterceptor(this.interceptorClassname);

        // If accessible, call it directly
        if (isAccessible) {
            return invoke(interceptor, invocationContext);
        }
     ...
     * @param interceptor the interceptor on which the method is called
     * @param invocationContext the invocation context given as an argument of the method
     * @return the result of the invocation
     * @throws Exception if invocation fails
     */
    private Object invoke(final Object interceptor, final EasyBeansInvocationContext invocationContext) throws Exception {
        try {
            return this.method.invoke(interceptor, invocationContext);
    ...
    public String toString() {
        ...
        sb.append("[className=");
        sb.append(this.interceptorClassname);
        sb.append(", method=");

 ...
 *
 * --------------------------------------------------------------------------
 * $Id: CommonsModelerException.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
...
public class CommonsModelerException extends Exception {
     ...
     */
    public CommonsModelerException(final String message) {
        super(message);
    }
     ...
     *        unknown.)
     */
    public CommonsModelerException(final String message, final Throwable cause) {
        super(message, cause);
    }

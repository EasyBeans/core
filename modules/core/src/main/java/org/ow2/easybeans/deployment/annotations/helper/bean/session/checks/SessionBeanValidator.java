 ...
 *
 * --------------------------------------------------------------------------
 * $Id: SessionBeanValidator.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
...
public final class SessionBeanValidator {
     ...
     * @param sessionBean Session bean to validate.
     */
    public static void validate(final EasyBeansEjbJarClassMetadata sessionBean) {

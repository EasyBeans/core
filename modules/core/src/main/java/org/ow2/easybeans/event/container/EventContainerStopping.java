 ...
 *
 * --------------------------------------------------------------------------
 * $Id: EventContainerStopping.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
...
/**
 * EasyBeans container stopping events.
...
public class EventContainerStopping extends AbstractEventContainer implements EZBEventContainerStopping {
     ...
     */
    public EventContainerStopping(final String source, final IArchive archive,

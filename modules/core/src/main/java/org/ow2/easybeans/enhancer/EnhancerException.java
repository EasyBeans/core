 ...
 *
 * --------------------------------------------------------------------------
 * $Id: EnhancerException.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
...
public class EnhancerException extends Exception {
     ...
     */
    public EnhancerException(final String message) {
        super(message);
    }
     ...
     *        unknown.)
     */
    public EnhancerException(final String message, final Throwable cause) {
        super(message, cause);
    }

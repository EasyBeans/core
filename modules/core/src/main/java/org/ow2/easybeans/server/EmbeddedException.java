 ...
 *
 * --------------------------------------------------------------------------
 * $Id: EmbeddedException.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
...
public class EmbeddedException extends EZBServerException {
     ...
     */
    public EmbeddedException(final String message) {
        super(message);
    }
     ...
     *        unknown.)
     */
    public EmbeddedException(final String message, final Throwable cause) {
        super(message, cause);
    }
     ...
     * @since 1.4
     */
    public EmbeddedException(final Throwable cause) {
        super(cause);
    }
}

 ...
 *
 * --------------------------------------------------------------------------
 * $Id: RemoteCallFactory.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
 ...
 */
public class RemoteCallFactory implements ObjectFactory {
    ...
    public Object getObjectInstance(final Object obj, final Name name, final Context nameCtx, final Hashtable<?, ?> environment)
        ...
        if (obj instanceof Reference) {
            ...
            // Stateful case ? needs to invoke a remote method in order to

 ...
 *
 * --------------------------------------------------------------------------
 * $Id: TwoAroundInvokeInterceptor.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
...
public class TwoAroundInvokeInterceptor {
     ...
     */
    @AroundInvoke
    public Object doException(final InvocationContext invocationContext) throws Exception{
        throw new IllegalStateException(
                "This interceptor has two @AroundInvoke and never can be executed. It's out of the specification.");
    }
     ...
     */
    @AroundInvoke
    public Object doException2(final InvocationContext invocationContext) throws Exception{
        throw new IllegalStateException(
                "This interceptor has two @AroundInvoke and never can be executed. It's out of the specification.");
    }

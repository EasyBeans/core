 ...
 *
 * --------------------------------------------------------------------------
 * $Id: SLSBTwoAroundInvokeError.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
 ...
 */
@Stateless
public class SLSBTwoAroundInvokeError implements ItfOneMethod00{
     ...
     */
    @AroundInvoke
    public Object doNothing1(final InvocationContext invocationContext) throws Exception{
     ...
     */
    @AroundInvoke
    public Object doNothing2(final InvocationContext invocationContext) throws Exception{
        return invocationContext.proceed();
    }

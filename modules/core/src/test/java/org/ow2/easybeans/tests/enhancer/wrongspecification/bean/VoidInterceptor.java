 ...
 *
 * --------------------------------------------------------------------------
 * $Id: VoidInterceptor.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
...
public class VoidInterceptor {
     ...
     */
    @AroundInvoke
    public void doException(final InvocationContext invocationContext) throws Exception{
        throw new IllegalStateException(
                "This interceptor has void return. It's out of the specification.");
    }
}

 ...
 *
 * --------------------------------------------------------------------------
 * $Id: TestException2.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
...
public class TestException2 extends Exception {
     ...
     */
    private static final long serialVersionUID = -2040419305599968404L;
     ...
     */
    public TestException2(final String message) {
        super(message);
    }
     ...
     *        unknown.)
     */
    public TestException2(final String message, final Throwable cause) {
        super(message, cause);
    }

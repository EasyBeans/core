 ...
 *
 * --------------------------------------------------------------------------
 * $Id: SLSBFinalExternalInterceptor.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
 ...
 */
@Stateless
public class SLSBFinalExternalInterceptor implements ItfOneMethod00{
     ...
     * @return null
     */
    @Interceptors({FinalMethodInterceptor.class})

 ...
 *
 * --------------------------------------------------------------------------
 * $Id: SLSBStaticInternalInterceptor.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
 ...
 */
@Stateless
public class SLSBStaticInternalInterceptor implements ItfOneMethod00{
     ...
     */
    @AroundInvoke
    public static Object doNothing(final InvocationContext invocationContext) throws Exception{

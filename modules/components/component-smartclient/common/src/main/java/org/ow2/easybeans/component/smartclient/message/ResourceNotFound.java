 ...
 *
 * --------------------------------------------------------------------------
 * $Id: ResourceNotFound.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
 ...
 *
 */
public class ResourceNotFound extends AbsNameMessage {

    /**
     * Builds a new message with the given name.
     * @param name the given name
     */
    public ResourceNotFound(final String name) {
        super(name);
    }
     ...
     */
    public ResourceNotFound(final ByteBuffer buffer) {
        super(buffer);
    }
    ...
    public byte getOpCode() {
        return ProtocolConstants.RESOURCE_NOT_FOUND;
    }
